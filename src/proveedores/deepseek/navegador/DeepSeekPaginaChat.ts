...
export class DeepSeekPaginaChat {
  ...
  constructor(transporte:TransporteNavegador, gestorPestanas?:GestorPestanas){this.nav=new DeepSeekNavegacion(transporte,undefined,gestorPestanas);this.modelos=new DeepSeekModelos(transporte);this.envio=new DeepSeekEnvio(transporte);this.stream=new DeepSeekStreaming(transporte);}
