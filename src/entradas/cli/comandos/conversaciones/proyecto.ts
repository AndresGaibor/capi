...
export const comandoConversacionesProyecto=defineCommand({
 meta:{name:"proyecto",description:"Listar historial de conversaciones del proyecto"},args:{output:{type:"string",alias:"o",default:"markdown"},archivadas:{type:"boolean"}},
