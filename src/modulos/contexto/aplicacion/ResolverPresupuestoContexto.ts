...
const POR_PROVEEDOR:Record<string,{bytes:number;tokens:number;cpt:number}>={qwen:{bytes:4*MIB,tokens:850000,cpt:3.6},deepseek:{bytes:4*MIB,tokens:890880,cpt:3.7},chatgpt:{bytes:4*MIB,tokens:128000,cpt:4}};
